...
<!-- Mirrored from theme685-baby-clothing.myshopify.com/collections by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 17:35:33 GMT -->
...
<head>
		...
		<link rel="canonical" href="age.php">
	...
	<body class="template-list-collections scheme_1">
...
<header id="page_header">
	<div class="page_container">
														...
														<li>
															<div><ul class="level_3">
																		...
																		<li class="level_3__item ">
																			<a class="level_3__link" href="index.php">Home</a>
		...
		<i class="level_1__trigger megamenu_trigger" data-submenu="menu_1524467474031"></i> 
				...
				<ul class='level_2' id='menu_1524467474031'><li class='container'>									
				<?php	
		$query="SELECT * from main_category";
         ...
         {
        //echo"<ul class='level_2' id='menu_1524467474031'><li class='container'>";
															
       echo "<div class='megamenu_col__item'>";
       echo"<img src='images/mcimages/{$catSet['mcategory_image'] }' alt=''>";
       echo"<h3 >{$catSet['mcategory_name']}<i class='level_2__trigger megamenu_trigger' data-submenu='menu_1524467474031-2'></i></h3>";
       echo "<ul class='level_3' id='menu_1524467474031-2'>";
       echo "<li class='level_3__item'><a class='level_3__link' href='age.php?id={$catSet['mcategory_id'] }'>{$catSet['mcategory_name']}</a>
	         </li>";
	   echo "</ul></div>";
...
<style>
	...
	<div class="main_content ">
	 <div id="shopify-section-template-collections-listing" class="shopify-section section_template section_template__collections-listing">
       <div class="container">
	<h1 class="page_heading">Kids Ages</h1>
	<div class='row collection_listing__main'>

	<?php
	$query="SELECT * FROM age where mcategory_id={$_GET['id']}";
	$result = mysqli_query($conn,$query);
	while($ageSet = mysqli_fetch_assoc($result)){
		//echo "<pre>";print_r($ageSet);
		//echo"<div class='container'>";
	//echp"<h1 class='page_heading'>Baby Girl Ages</h1>";
	//echo "<div class='row collection_listing__main'>";
	echo"<div class='col-xs-3 '>";
	echo"<div class='collection_item flexible_block flexible_block__normal flexible_block__hover flexible_block__'>";
					
	echo"<a href='mproduct.php?id={$ageSet['age_id']}'>";
    echo "<div class='layer_1 collection_img'>";
    echo "<div class='img_placeholder__wrap img_placeholder__medium' style='background-image: url(images/ageimages/{$ageSet['age_image']}); height:200px;width:250px;'></div></div>";
    //echo "</div>";
    echo "<div class='layer_2'>
    <div>
			<span class='collection_title'>{$ageSet['age']}</span>
       </div>
	</div></a></div></div>";
		}
	?>
	...
	<div class="footer_row__1 " > 
		<div class="container" >
			...
			<div class="row footer_main">
					...
					<div class="col-sm-3 footer_block footer_block__2_1"style="margin-left: 100px;">
...
<p>Childhood is a special time, when you can carelessly enjoy life at its full. For our part, we do everything to make it possible. Rely on us with all of your baby clothing needs and focus on what matters the most &ndash; smiles, cuddles, joyful eyes, and other little things that will make you happy as a parent.</p></div>
					...
					<div class="col-sm-3 footer_block footer_block__2_1" style="margin-left: 150px;">
...
<div class="footer_item footer_item__links " style="margin-left: 100px;" >
									<h3>My Account</h3>
...
<script id="__st">var __st={"a":24595202108,"offset":-14400,"reqid":"092084da-30b8-4f97-94da-00f4751b324e","pageurl":"theme685-baby-clothing.myshopify.com\/collections","u":"80848a369570","p":"collections"};</script>
...
<script id="sections-script" data-sections="header,footer" defer="defer" src="../cdn.shopify.com/s/files/1/0245/9520/2108/t/2/compiled_assets/scripts75b9.js?3104"></script>
...
<!-- Mirrored from theme685-baby-clothing.myshopify.com/collections by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 17:35:47 GMT -->
</html>