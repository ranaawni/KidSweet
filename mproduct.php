...
<head>
		...
		<link rel="canonical" href="mproduct.php">
...
<header id="page_header">
	<div class="page_container">
       ...
       echo "<li class='level_3__item'><a class='level_3__link' href=''>{$catSet['mcategory_name']}</a>
	         </li>";
	   echo "</ul></div>";
...
<style>
	...
	<div class="container">
		<ul>
			<li><a href="index.php">Home</a></li>
					...
					<li><a href="age.php"><span>Kids Ages</span></a></li>
					<li><span>Main Products</span></li>
	...
	<div class="main_content ">
	 <div id="shopify-section-template-collections-listing" class="shopify-section section_template section_template__collections-listing">
       <div class="container">
	<h1 class="page_heading">Main Products</h1>
	<div class='row collection_listing__main'>

	<?php
	$query="SELECT * FROM main_product where age_id={$_GET['id']}";
	$result = mysqli_query($conn,$query);
	while($mproSet = mysqli_fetch_assoc($result)){
		
	echo"<div class='col-xs-3 ' style='margin-left:100px;'>";
	echo"<div class='collection_item flexible_block flexible_block__normal flexible_block__hover flexible_block__'>";
					
	echo"<a href='collections/product.php?id={$mproSet['mproduct_id']}'>";
    echo "<div class='layer_1 collection_img'>";
    echo "<div class='img_placeholder__wrap img_placeholder__medium' style='background-image: url(images/mpimages/{$mproSet['mproduct_image']}); height:290px;width:300px;'></div></div>";
    //echo "</div>";
    echo "<div class='layer_2'>
    <div>
			<span class='collection_title'>{$mproSet['mproduct_name']}</span>
       </div>
	</div></a></div></div>";
		}
	?>
